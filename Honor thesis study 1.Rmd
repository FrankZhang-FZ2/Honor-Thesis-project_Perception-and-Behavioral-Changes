...
HT_MC1 <- subset(HT_MC1, as.numeric(HT_MC1$`Q56_Page Submit`)>=200)

##Labeling condition
HT_MC1$Condition <- ifelse((is.na(HT_MC1$Self_S_reflect)== FALSE),"self",(ifelse(is.na(HT_MC1$Other_O_reflect)== FALSE, "other", "self&other")))
...
levels=c("benefited the others extremely more than the volunteers themselves","benefited the others moderately more than the volunteers themselves","benefited the others slightly more than the volunteers themselves","benefited others and the volunteers themselves equally","benefited the volunteers themselves slightly more than others","benefited the volunteers themselves moderately more than the others","benefited the volunteers themselves extremely more than the others"),
